...
import { BadResourceCreationArguments } from "../../errors";
...
const createNewExtraEntry = async (
  ...
  if (!extra) {
    throw new BadResourceCreationArguments("Invalid extra");
  }

  if (maxSelection < minSelection) {
    throw new BadResourceCreationArguments(
      "max selection can't be greater than min selection"
    );
  }
